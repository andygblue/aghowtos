...
# Updated for CP4I 16.1.0.5 September Fixpack 
...
# IBM Event Endpoint Management (EEM) - update to EEM 11.3.1
oc apply --filename https://raw.githubusercontent.com/IBM/cloud-pak/master/repo/case/ibm-eventendpointmanagement/11.3.1/OLM/catalog-sources.yaml
