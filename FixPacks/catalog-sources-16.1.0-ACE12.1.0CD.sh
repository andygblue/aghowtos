...
# Updated for CP4I 16.1.0 and ACE 12.1.0 CD
...
# IBM App Connect 12.1.0 CD
export OPERATOR_PACKAGE_NAME=ibm-appconnect
export OPERATOR_VERSION=12.1.0
deploy_catalog_source
...
export OPERATOR_VERSION=11.2.0+20240603.010000
deploy_catalog_source

# IBM DataPower Gateway
export OPERATOR_PACKAGE_NAME=ibm-datapower-operator
export OPERATOR_VERSION=1.11.0
deploy_catalog_source
